...
const PLUGIN_ROUTES = ["grinders", "bean-picker", "grinder-picker", "profile-picker", "roasters", "add-bean", "dashboard", "edit-shot", "auto-favs", "auto-fav-edit", "recipe-edit", "plotly"];
